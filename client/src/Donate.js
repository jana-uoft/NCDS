      ...
      <div className="container clearfix">
        <div className="col_full">
          ...
          <div className="fancy-title title-dotted-border">
            <h3>Contact us about Donations</h3>
          </div>
        ...
        <div className="row clear-bottommargin">
          ...
          <div className="col-lg-4 col-md-6 bottommargin clearfix">
            <div className="feature-box fbox-center fbox-bg fbox-plain">
              <div className="fbox-icon">
                <a><i className="icon-realestate-moneybox"></i></a>
              </div>
              <h3>Pay Once</h3>
            </div>
          </div>
          ...
          <div className="col-lg-4 col-md-6 bottommargin clearfix">
            <div className="feature-box fbox-center fbox-bg fbox-plain">
              <div className="fbox-icon">
                <a><i className="icon-money"></i></a>
              </div>
              <h3>Contribute Yearly</h3>
            </div>
          </div>
          ...
          <div className="col-lg-4 col-md-6 bottommargin clearfix">
            <div className="feature-box fbox-center fbox-bg fbox-plain">
              <div className="fbox-icon">
                <a><i className="icon-realestate-money"></i></a>
              </div>
              <h3>Give a Scholarship</h3>
            </div>
          </div>
